...
export async function getServerSideProps(context) {
  ...
  const currentFile = await getRequest(`https://${apiDomain}/assets?path=${(context.params.assetPath || []).join('/')}`);
...
export default function Events({ assetBaseUrl, apiDomain, rootItems, currentFile }) {
